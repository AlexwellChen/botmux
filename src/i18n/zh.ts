...
export const messages: Record<string, string> = {
  ...
  // 群内授权卡片
  'card.grant.title': '授权申请',
  'card.grant.body_request': '**{name}** 申请在本群与我对话，等待 <at id={owner}></at> 确认。',
  'card.grant.body_owner': '为 **{name}** 开通对话权限。操作人：<at id={owner}></at>',
  'card.grant.body_owner_multi': '为 {names} 开通对话权限。操作人：<at id={owner}></at>',
  'card.grant.btn_chat': '允许',
  'card.grant.btn_global': '全局允许',
  ...
  'card.grant.more_limits': '更多限制',
  'card.grant.more_limits_summary': '更多限制 · 默认 {n} 条消息',
  'card.grant.quota_label': '消息额度',
  'card.grant.quota_option': '{n} 条',
  'card.grant.quota_unlimited': '无限条',
  'card.grant.quota_placeholder': '输入正整数，留空表示不限',
  'card.grant.note': '到期或额度用完后自动收回 · 仅限对话',
