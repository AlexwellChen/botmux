...
export const messages: Record<string, string> = {
  ...
  'cmd.detach.not_adopted': 'This is not a persistent session whose CLI can be preserved; /detach does not apply. Use /close to end it.',
  ...
  'help.detach': '/detach             - Disconnect Botmux but preserve the persistent CLI for a later /adopt (/disconnect is an alias)',
