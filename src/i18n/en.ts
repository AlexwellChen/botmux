...
export const messages: Record<string, string> = {
  ...
  'card.grant.body_request': '**{name}** wants to talk to me in this chat. Waiting for <at id={owner}></at>.',
  'card.grant.body_owner': 'Grant **{name}** talk access. Operator: <at id={owner}></at>',
  'card.grant.body_owner_multi': 'Grant {names} talk access. Operator: <at id={owner}></at>',
  'card.grant.btn_chat': 'Allow',
  'card.grant.btn_global': 'Allow globally',
  ...
  'card.grant.more_limits': 'More limits',
  'card.grant.more_limits_summary': 'More limits · {n} messages by default',
  'card.grant.quota_label': 'Message quota',
  'card.grant.quota_option': '{n} messages',
  'card.grant.quota_unlimited': 'Unlimited',
  'card.grant.quota_placeholder': 'Positive integer; leave blank for unlimited',
  'card.grant.note': 'Revoked on expiry or quota exhaustion · Talk-only',
