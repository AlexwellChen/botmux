...
export const BOTMUX_INJECTED_ENV_KEYS = [
  ...
  'BOTMUX_BRAND_LABEL',
  // Default-on per-bot display preference for Context / Token usage in reply
  // card footers. Injected explicitly so sandboxed offline fallback cannot
  // drift to the default when bots.json is unreadable.
